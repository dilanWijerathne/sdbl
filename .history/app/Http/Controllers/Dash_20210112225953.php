...
class Dash extends Controller
{
    ...
    public function create_fd($para)
    {
        ...
        $I_DISPOSTION_CODE = "";
        if ($para['interest_payable_at'] === "disposeOther") {
            $I_DISPOSTION_CODE = "T";
        } else {
            $I_DISPOSTION_CODE = "C";
        }
        ...
        $response = Http::post($url, [
            ...
            "SEQUENCE_NO" => "0",
            "PRODUCT_TYPE" => $act[$para['product']], //"162", // add relevent product type from table
            "OFFICER_CODE" => $para['empId'], // officer epf number
            "OPEN_DATE" => $para['today'],   // julina today
            "FACE_AMOUNT" => $para['desposit'], //"500000",
            "TESSA_TYPE" => "0",
            "RETIRE_PLAN_NUM" => "",
            "P_DISPOSTION_CODE" => "N",
            "I_DISPOSTION_CODE" =>  $I_DISPOSTION_CODE, // "C",
            "SOURCE_OF_FUNDS" => "1",
            "DEPOSIT_AMOUNT" => $para['desposit'],
            "APPLICATION_DATE" => "0",
            "TITLE_MODIFER" => "",
            "ST_ACCRUAL_DATE" => "0",
            "FUNDS_AVAIL_DATE" => "0",
            ...
            "RENEWAL_OPTION" => "A",
            "RENUWAL_PERIOD" => "M",
            "RENEWAL_FREQUENCY" => $para['period'], // "24",
            ...
            "INTERNAL_ACCOUNT_N0" => $para['interest_transfer_account'],
            "AMOUNT" => "0",
            "DESCRIPTION" => "",
