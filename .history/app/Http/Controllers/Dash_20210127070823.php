...
*/
        ...
        $response = Http::post($url, [
            ...
            "SEQUENCE_NO" => "0",
            "PRODUCT_TYPE" => $fd_code, //"162", // add relevent product type from table
            "OFFICER_CODE" => "119", //"TAB", // "MOB", //$para['empId'], // officer epf number
            "OPEN_DATE" => "2020339", // $para['today'],   // julina today
            "FACE_AMOUNT" => $fd['desposit'], //"500000",
            "TESSA_TYPE" => "0",
            "RETIRE_PLAN_NUM" => "",
            "P_DISPOSTION_CODE" => "N",
            ...
            "APPLICATION_DATE" => "0",
            "TITLE_MODIFER" => "",
            "ST_ACCRUAL_DATE" => "2020339", // $para['today'],   // julina today
            "FUNDS_AVAIL_DATE" => "2020339", // $para['today'],   // julina today
            "PER_NON_PER_CODE" => "P",
            "INTEREST_RATE" => "0.098500",
            "SEND_RC_NOTICE" => "",
            "NEGOTIABLE_FLAG" => "",
            ...
            "RENUWAL_PERIOD" => "M",
            "RENEWAL_FREQUENCY" => $fd['period'], // "24",
            "RENEWAL_SPEC_DAY" =>  "4", //"2020339",// $para['today'],   // julina today // "06",   change when go live
            "NEXT_REN_MAT_DATE" => "0",
            "SWAP_RATE" => "0",
            "PAYMENT_PERIOD" => "M",
            "PAYMENT_FRE_CY" => "4", //$this->fd_payment_frq($fd['period'], $fd['interest_disposal_method']),
            ...
            "ACCRUAL_BASE" => "2",
            "YEAR_BASE" => "2",
            "ACCOUNT_OPEN_DATE" => "2020339", // $para['today'],   // julina today// "2020280",
            "DATE_OF_BIRTH" => "0",
            "LIFE_EXPEC_YEAR" => "0",
            "LIFE_EXPEC_MONTH" => "0",
            "ALLO_CONT_THIS_YR" => "0",
            ...
            "STATUS" => "1",
            "USER_ID" => $para['empId'],
            "DATE" => "2020339", // $para['today'],   // julina today // "20201101",
            "TIME" =>   time(), //"20020010",
            "FIELD1" => "0",
            "FIELD2" => "0",
            "FIELD3" => "0",
