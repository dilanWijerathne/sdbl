...
*/
        ...
        if ($user === 0 | $user === "0") {
            ...
            if (isset($request->app_status)) {
                ...
                if ((int)$request->app_status === 0 | (int)$request->app_status !== 10) {
                    $order_by = "created_at";
                } else {
                    $order_by = "updated_at";
                }
            ...
            /*else {
                    ...
                    $models = DB::table('applicant')
                        ...
                        ->get()
                        ->map(function ($item) {
                            return [$item->ref, $item->branch, $item->title,  $item->full_name,  $item->nic, $item->primary_mobile_number, $item->updated_at, $item->signed];
                        })->toArray();
